...
#graph 4
#create a datetime field and the graphs.

#Global_active_power graph
...
##############################
#voltage graph
with(data.sub, plot(DateTime, Voltage, type="n", xlab="datetime"))
lines(data.sub$DateTime,data.sub$Voltage)


##################################
#global reactive power graph
with(data.sub, plot(DateTime, Global_reactive_power, type="n", xlab="datetime"))
lines(data.sub$DateTime,data.sub$Global_reactive_power)
